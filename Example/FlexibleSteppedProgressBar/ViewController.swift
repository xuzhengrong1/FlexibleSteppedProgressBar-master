...
//    var progressBarWithoutLastState: FlexibleSteppedProgressBar!
    ...
    var backgroundColor = UIColor.white //UIColor(red: 218.0 / 255.0, green: 218.0 / 255.0, blue: 218.0 / 255.0, alpha: 1.0)
    var progressColor = UIColor.red //UIColor(red: 53.0 / 255.0, green: 226.0 / 255.0, blue: 195.0 / 255.0, alpha: 1.0)
...
//            constant: 300
//        )
//        let widthConstraint = progressBarWithoutLastState.widthAnchor.constraint(equalToConstant: 320)
...
//    }
    ...
    func setupProgressBarWithDifferentDimensions() {
        ...
        progressBarWithDifferentDimensions.selectedBackgoundColor = UIColor.red//progressColor
...
//            constant: 80
//        )
//        let widthConstraint = progressBar.widthAnchor.constraint(equalToConstant: CGFloat(320))
